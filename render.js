...
`;
    document.querySelector(".add-form").innerHTML = loginHtml;
    ...
    registrationBtn.addEventListener("click", () => {
        ...
        <button type="button" id="authNewBtn">Войти</button>
        </div>
        `;
        const regBtn = document.getElementById("reg-btn");
        const newAuthBtn = document.getElementById("authNewBtn");
        ...
        regBtn.addEventListener("click", () => {
            ...
            const loginRegElement = document.getElementById("loginReg-input");
            const passRegElement = document.getElementById("passwordReg-input");
...
export const renderLinkAuthorization = () => {
  ...
  `;
    document.querySelector(".add-form").innerHTML = linkHtml;
